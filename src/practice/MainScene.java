...
//	
//	//collision detected
//	ArrayList<Sprite> _fighter_Missile;
//	ArrayList<Sprite> _enemyArray;
//	ArrayList<Sprite> _enemy_Millsile;
//
//    
...
//    	System.out.println(_fighter_Missile.get(0).getBound());
////    	System.out.println(_fighter_Missile.size());
...
////		System.out.println("enemy qty-01: "+_enemyArray.size());
//		
...
//				//-------			
//				
//				for(Sprite a:_enemy_Millsile){
//					Rectangle enemybullet = a.getBound();
////					System.out.println("ebullet x: "+a.getBound().x+" y: "+a.getBound().y);
//					Rectangle fighter = _fighter.getBound();
//					
//					if(enemybullet.intersects(fighter)){
//						System.out.println("inter eBullet x: "+enemybullet.x+", eBullety: "+enemybullet.y);
//						System.out.println("inter fighter x: "+fighter.x+", eBullety: "+fighter.y);
//
//						System.out.println("inter hurt");
//					}
//				}
//								
////		    	System.out.println("begin size:"+_render_objects.size());
...
//				addToScene(enemyBullet);
//				_enemy_Millsile.add(enemyBullet);
//				System.out.println("_enemy3 missile: "+_enemy_Millsile.size());
//
...
//				addToScene(enemyBullet);
//				_enemy_Millsile.add(enemyBullet); //array for collision
//				System.out.println("_enemy2 missile: "+_enemy_Millsile.size());
//
////							System.out.println("e bullet");
////		    	System.out.println("begin size:"+_render_objects.size());
//
...
//				addToScene(enemyBullet);
//				_enemy_Millsile.add(enemyBullet); //array for collision
//				System.out.println("_enemy1 missile: "+_enemy_Millsile.size());
////									System.out.println("e bullet");
////		    	System.out.println("begin size:"+_render_objects.size());
//
//				//check if bullet out of boundary
...
//						if(enemyBullet.bullet_img != null){					
//							removeFromScene(enemyBullet);
//							_enemy_Millsile.remove(enemyBullet); //array for collision
//							checkBoundary.cancel();//cancel timer when remove bullet
////												ebulletTimer.cancel();
////							System.out.println("after size:"+_render_objects.size());
//						}
